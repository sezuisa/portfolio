...
export default function ImageViewer({
  ...
  // Extract src from child <Image /> if not explicitly provided
  let effectiveSrc = src;
  if (!src && children && isValidElement(children)) {
    if ((children as any).props?.src) {
      effectiveSrc = (children as any).props.src;
    }
  }

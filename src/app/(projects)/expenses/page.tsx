        ...
        <div className="mx-auto container flex flex-col items-center px-4 pt-4 pb-25 lg:px-16">
            ...
            <div className="max-w-full lg:max-w-150 lg:max-h-300 z-1">
              <EditorBox>
                ...
                <div className="max-w-prose space-y-3">
                  <p>
                    Between March and June 2025, I led a six-week group project
                    as part of my UX Design Master&apos;s at Loughborough
                    University. Partnered with MHR, a leading HR and payroll
                    solutions provider from Nottingham, our brief was:
                  </p>
                  <h4>
                    &quot;Improve the end-to-end expense management process by
                    being bold and creative - leveraging the power of automation
                    and AI.&quot;
                  </h4>
                  <p>
                    Working in an agile team of six, I took on the role of team
                    leader, co-ordinator, and main client communicator. I
          ...
          <div className="flex items-center justify-center my-10">
            <div className="max-w-prose space-y-3">
              ...
              <p>
                ...
                insights from all our different research findings.
              </p>
            </div>
          </div>
          ...
          <div className="max-w-prose space-y-3 py-10">
            ...
            <h4 className="font-bold">
              At the core, each refinement was guided by our validated belief in
              a concept that focused on an AI- and chat-first approach, setting
              ourselves the goal of creating not just another expense management
              solution, but something that feels like your personal expenses
              officer.
            </h4>
            <p>
            ...
            <div className="max-w-full lg:max-w-150 lg:max-h-300 z-0">
              <EditorBox extraStyles="pt-6 lg:pt-0 lg:pr-10">
                ...
                <p>
                  ...
                  friendly, personal expenses officer who does most of the work
          ...
          <div className="max-w-prose space-y-3 my-10">
            <p>
              They also commended our professionalism and deep understanding of
              user needs, adding:
            </p>
          </div>
          ...
          <div className="max-w-prose space-y-3 my-10">
            <p>
              This positive feedback validated our approach and demonstrated the
              impact that bold, user-centred, and AI-integrated design can have
              in addressing organisational challenges.
            </p>
          </div>
          ...
          <div className="max-w-prose space-y-3 my-10">
            ...
            <ul className="list-disc pl-5">
              ...
              <li className="text-[#6270D1]">
                Developing prototypes and incorporating user feedback to refine
                our designs iteratively
              </li>
            </ul>
          </div>
          ...
          <div className="max-w-prose space-y-3 mb-10">
            ...
            <p>
              ...
              leader, I became aware that I can sometimes focus too strongly on
              my own ideas. Moving forward, I will continue to actively create
